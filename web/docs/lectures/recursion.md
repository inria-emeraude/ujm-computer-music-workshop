...
* This filter behaves similarly to the feedforward comb filter studied in [Session 3](../session3), except that its “lobes” have a much more aggressive effect.
* Note that the flanger from [Session 3](../session3) can be reimplemented using this feedback comb filter.
